function start(game_just_loaded)
	...
	chest = Chest_Puzzle:new{layer=2, x=13.5*TILE_SIZE, y=7.5*TILE_SIZE, milestone="chest_puzzle3", other_ms_1="chest_puzzle1", other_ms_2="chest_puzzle2", other1=false, other2=true}
...
function logic()
	if (to_caverns5:entity_is_colliding(0)) then
		next_player_layer = 2
		change_areas("caverns5", DIR_S, 26.5*TILE_SIZE, 9.5*TILE_SIZE)
	end
