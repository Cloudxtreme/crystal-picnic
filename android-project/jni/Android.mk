...
LOCAL_ARM_MODE := arm
LOCAL_CFLAGS    := -I/Users/Trent/bin/android/$(TARGET_ARCH_ABI)/include -I../include -Wall $(DEMO)

LOCAL_LDLIBS    := -L/Users/Trent/bin/android/$(TARGET_ARCH_ABI)/lib -L$(LOCAL_PATH)/$(TARGET_ARCH_ABI) -llog libs/$(TARGET_ARCH_ABI)/liballegro_monolith.so -lGLESv1_CM -llua5.2 -lz -lbass -lbassmidi -ltgui2 -lpoly2tri -latlas -lwrap -lstdc++
