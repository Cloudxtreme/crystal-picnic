...
public class BASS
{
	...
	// BASS_Init flags
	public static final int BASS_DEVICE_8BITS = 1;	// use 8 bit resolution, else 16 bit
	public static final int BASS_DEVICE_MONO = 2;	// use mono, else stereo
	public static final int BASS_DEVICE_3D = 4;	// enable 3D functionality
	public static final int BASS_DEVICE_LATENCY = 256;	// calculate device latency (BASS_INFO struct)
	public static final int BASS_DEVICE_CPSPEAKERS = 1024; // detect speakers via Windows control panel
	public static final int BASS_DEVICE_SPEAKERS = 2048; // force enabling of speaker assignment
	public static final int BASS_DEVICE_NOSPEAKER = 4096; // ignore speaker arrangement
