...
#if (defined __linux__ && (!defined OUYA && !defined FIRETV)) || defined ALLEGRO_IPHONE || defined ALLEGRO_MACOSX
...
void Engine::choose_joystick()
{
       ...
       return;
#endif
#if (defined ALLEGRO_ANDROID && (!defined OUYA && !defined FIRETV)) || defined ALLEGRO_IPHONE
	cfg.use_joy = true;
	return;
#endif
