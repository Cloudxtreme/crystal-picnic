...
LOCAL_ARM_MODE := arm
LOCAL_CFLAGS    := -I$(ANDROID_DIR)/$(TARGET_ARCH_ABI)/include -I../include -Wall $(DEMO) -DOUYA -DOUYA_OFFICIAL $(NO_DRM)

LOCAL_LDLIBS    := -L$(ANDROID_DIR)/$(TARGET_ARCH_ABI)/lib -L$(LOCAL_PATH)/$(TARGET_ARCH_ABI) -llog -latlas -ltgui2 -lwrap libs/$(TARGET_ARCH_ABI)/liballegro_monolith.so -llua5.2 -lfreetype -lz -lbassmidi -lbass -lpoly2tri -lGLESv1_CM -lstdc++
